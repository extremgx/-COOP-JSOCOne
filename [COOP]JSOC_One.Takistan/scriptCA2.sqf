...
_group_east_3 = createGroup _east;
	...
	if (true) then
	{
		_group_east_3_unit_1 = _group_east_3 createUnit ["O_soldier_TL_F", [1049.999, 4126.7847, 0], [], 0, "CAN_COLLIDE"];
	...
	if (true) then
	{
		_group_east_3_unit_2 = _group_east_3 createUnit ["O_soldier_AR_F", [1054.999, 4121.7847, 0], [], 0, "CAN_COLLIDE"];
	...
	if (true) then
	{
		_group_east_3_unit_3 = _group_east_3 createUnit ["O_soldier_GL_F", [1044.999, 4121.7847, 0], [], 0, "CAN_COLLIDE"];
	...
	if (true) then
	{
		_group_east_3_unit_4 = _group_east_3 createUnit ["O_soldier_LAT_F", [1059.999, 4116.7847, 0], [], 0, "CAN_COLLIDE"];
		_group_east_3_unit_4 setUnitAbility 0.40000001;
	};
	// End of Unit _group_east_3_unit_4
	// Waypoints for _group_east_3
	// Waypoint #1
	_wp = _group_east_3 addWaypoint[[1658.3021, 3516.8442, 0], 0, 1];
